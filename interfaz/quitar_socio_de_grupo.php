...
if($respuesta == "")
header('Location: /persistencia/nombre_grupos2.php');
...
$result = $_SESSION["result"];
 ...
 if($respuesta == "No_existe"){
		...
		echo"<FONT COLOR='red'>El Soci@ con ese DNI no esta registrado </FONT> <br> <br> ";
	}

	else if($respuesta == "OK") {
		echo"<FONT COLOR='green'>Soci@ elminado de grupo correctamente</FONT> <br> <br> <meta http-equiv='refresh' content='5;url=./main.html'>";
	}
?>
...
<form  method="get" action="/persistencia/quitar_socio_de_grupo.php" class="form-horizontal">
	<fieldset>
	<h3>Quitar a un soci@ de un grupo de trabajo</h3>
