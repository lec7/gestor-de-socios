...
if ( isset($_GET["respuesta"]) )
	$respuesta = ($_GET["respuesta"]);
 	...
 	if($respuesta == "Existe")
	 echo"	<FONT COLOR='red'>Ya existe un grupo con ese nombre</FONT> <br> <br> ";

	
	else if($respuesta == "OK"){
		echo"	<FONT COLOR='green'>Grupo creado correctamente</FONT> <br> <meta http-equiv='refresh' content='5;url=./main.html'>
 ";
	}
?>
...
<form  method="get" action="/persistencia/nuevo_grupo.php">
	<fieldset>	
	<h3>Creacion de nuevo grupo de trabajo</h3>
	Nombre del grupo: <input name="nombre" autocomplete='off'>
	</br>
