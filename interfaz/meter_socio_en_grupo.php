...
if($respuesta == "")
header('Location: /persistencia/nombre_grupos.php');
...
$result = $_SESSION["result"];
 ...
 if($respuesta == "No_existe"){
		...
		echo"<FONT COLOR='red'>El GRUPO insertado no esta registrado en el sistema</FONT> <br> <br> ";
	}

	else if($respuesta == "Existe"){
		echo"<FONT COLOR='red'>El Soci@ con ese DNI ya esta registrado en ese grupo </FONT> <br> <br> ";
	}

	else if($respuesta == "OK") {
		echo"<FONT COLOR='green'>Soci@ insertado en grupo correctamente</FONT> <br> <br> <meta http-equiv='refresh' content='5;url=./main.html'>";
	}
?>
...
<form  method="get" action="/persistencia/meter_socio_en_grupo.php" class="form-horizontal">
	<fieldset>
	<h3>Añadir a un soci@ a un grupo de trabajo</h3>
	
	DNI:  <input name="DNI" autocomplete="off"> </br>
	Grupo de trabajo: <input list="grupo" name="grupo" autocomplete="off">
				<datalist id="grupo">
  				<?php
