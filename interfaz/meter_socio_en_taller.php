...
if($respuesta == "")
header('Location: /persistencia/nombre_talleres.php');
...
$result = $_SESSION["result"];
 ...
 if($respuesta == "No_existe"){
		...
		echo"<FONT COLOR='red'>El Soci@ con ese DNI ya esta registrado en ese taller </FONT> <br> <br> ";
	}

	else if($respuesta == "OK") {
		echo"<FONT COLOR='green'>Soci@ insertado en taller correctamente</FONT> <br> <br> <meta http-equiv='refresh' content='5;url=./main.html'>";
	}
?>
...
<form  method="get" action="/persistencia/meter_socio_en_taller.php" class="form-horizontal">
	<fieldset>
	<h3>Añadir a un soci@ a un taller</h3>
