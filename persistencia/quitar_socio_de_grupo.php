...
$sqlDelete = "DELETE FROM Grupo_socio WHERE grupo_trabajo =  '". $_GET["grupo"] . "'AND socio = '" . $_GET["DNI"]. "'";
...
//si no hay resultados, avisar que no hay socio con ese DNI
	...
	if($result3->num_rows > 0){
		...
		header('Location: /interfaz/quitar_socio_de_grupo.php?respuesta=OK'); 
	
	
	}

	else header('Location: /interfaz/quitar_socio_de_grupo.php?respuesta=NO_Existe');
